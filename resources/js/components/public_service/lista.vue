<template>
    <div>
        ...
        <div class="d-md-flex align-items-center mb-3">
            <div class="breadcrumb-title pr-3">Servicios públicos</div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr v-for="(item, key) in data.data" :key="key">
                                <th>
                                    <img :src="asset + 'storage/public_services/' + item.image" style="width: 60px;" v-if="item.image">
                                </th>
                                <td>{{ item.name }}</td>
...
<script>
    export default {
        ...
        methods: {
            _getData(page = 1) {
                axios
                    .get("public_services/get-all-paginate?page=" + page, {
