<template>
    <div>
        ...
        <div class="d-md-flex align-items-center mb-3">
            <div class="breadcrumb-title pr-3">Casas</div>
            
            <div class="ml-auto">
                <casa-modal-crear-editar-component @updateList="_updateList" :attrib="attrib" :asset="asset"></casa-modal-crear-editar-component>
            </div>
        </div>
        <!--end breadcrumb-->
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="Número de casa" v-model="busqueda.name">
...
<script>
    export default {
        ...
        methods: {
            _getData(page = 1) {
                axios
                    .get("casas/get-all-paginate?page=" + page, {
                        params: this.busqueda,
                    })
                    .then((response) => {
                        this.data = response.data.casas;
                    })
                    .catch((err) => {
                        console.log(err);
                    });
