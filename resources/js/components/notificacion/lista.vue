<template>
    <div>
        ...
        <div class="d-md-flex align-items-center mb-3">
            ...
            <div class="ml-auto">
                <notificacion-modal-crear-editar-component @updateList="_updateList" :attrib="attrib" :asset="asset"></notificacion-modal-crear-editar-component>
            </div>
        </div>
        <!--end breadcrumb-->
                    ...
                    <table class="table table-hover">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col" v-if="auth.rol_id != 1">Creado por</th>
                        ...
                        <tbody>
                            <tr v-for="(item, key) in data.data" :key="key">                            
                                <td class="notificacion">{{ item.texto }}</td>
                                <td v-if="auth.rol_id != 1">{{ auth.id == item.created_by_id ? 'Tú' : item.user }}</td>
                                <td>
