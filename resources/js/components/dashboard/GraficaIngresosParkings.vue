        ...
        <div class="card radius-15">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0">($) Ingresos de parqueaderos</h5>
                    </div>
                ...
                <div id="grafica_ingresos_parking"></div>
            </div>
        </div>
    </div>
</template>
...
<script>
    export default {
        ...
        methods: {
            async _getData() {
                return await axios
                    .get("dashboard/get_ingresos_parkings", {
                        params: {
                            year: this.year
                        },
                    })
        ...
        mounted() {
            ...
            this.chart = new ApexCharts(document.querySelector("#grafica_ingresos_parking"), options1);
            this.chart.render();
